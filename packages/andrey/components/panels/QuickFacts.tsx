...
const engineeringDomains = [
  { name: 'iOS / Mobile', techs: ['Swift', 'SwiftUI', 'Objective-C', 'ARKit', 'React Native'] },
  { name: 'Web', techs: ['React', 'TypeScript', 'Next.js', 'Vue.js'] },
  { name: 'Backend', techs: ['Python', 'Django', 'FastAPI', 'ASP.NET', 'Node.js'] },
  { name: 'AI / ML', techs: ['LangChain', 'LangGraph', 'OpenCV', 'RAG', 'LiteLLM'] },
  { name: 'Games / 3D', techs: ['Unity3D', 'C#', 'ARKit', 'SceneKit'] },
];
...
function DomainsContent() {
  return (
    <div className="flex flex-col items-center text-center">
      <SlotCounter value={engineeringDomains.length} />
      <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
        Engineering Domains
      </p>
...
function DomainsExpandedContent() {
  return (
  ...
  return (
    ...
    >
      ...
      <BentoCard
        id="skills"
        index={1}
        expandedContent={<DomainsExpandedContent />}
        {...cardProps}
      >
        <DomainsContent />
      </BentoCard>
